...
4. Read and fill `00_controller/project_profile.md`.
5. Read and fill `00_controller/dependency_setup.md`.
6. Run or request the permanent environment check:
...
7. Read `00_controller/session_registry.md`.
8. Reuse fixed specialist sessions when listed and active.
9. If a required specialist session is missing, create it or ask the user to create it, then record its ID.
10. Write the first dispatch to `00_controller/dispatch_log.md`.
11. Send the bounded dispatch prompt from `references/dispatch-templates.md`.
12. Wait for a durable handoff before dispatching the next phase.
